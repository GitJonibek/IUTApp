...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStatusBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                status_intent.putExtra("status", mStatus.getText());
        ...
        mImageBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Alternative way -->
                /*Intent galleryIntent = new Intent(Intent.EXTRA_CHOOSER_TARGETS);
    ...
    private void initComponents() {
        mDisplayimage = findViewById(R.id.settings_circleimageview);
        mName = findViewById(R.id.settings_display_name);
        mStatus = findViewById(R.id.sett_status);

        mStatusBtn = findViewById(R.id.settings_status_btn);
        mImageBtn = findViewById(R.id.settings_image_btn);

        mProfileImageStorageRef = FirebaseStorage.getInstance().getReference();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                StorageReference filepath = mProfileImageStorageRef.child("profile_images").child(current_uid + ".jpg");
                final StorageReference thumbPath = mProfileImageStorageRef.child("profile_images").child("thumbs").child(current_uid + ".jpg");
